...
//		nemo.setBounds(30, 30, 620, 620);
		...
		JLabel jl = new JLabel("게임을 진행하시겠습니까?");
		jl.setForeground(Color.WHITE);
		jl.setBounds(80, 50, 260, 100);
		jl.setFont(new Font("DX새날B", Font.BOLD, 30));
	...
	public void ingamepanel(JFrame mf, JPanel jp, User user, int stageNumber) {
		...
		itemK = new JLabel(new ImageIcon(new ImageIcon("images/강림.png").getImage().getScaledInstance(80, 130, 0)));
		itemK.setBounds(660, 580, 80, 130);

		itemD = new JLabel(new ImageIcon(new ImageIcon("images/덕춘.png").getImage().getScaledInstance(80, 130, 0)));
		...
		if(stageNumber == 1) {
			...
			king = new JLabel(new ImageIcon(new ImageIcon("images/은진.jpg").getImage().getScaledInstance(180, 250, 0)));
		}else if(stageNumber == 5) {
			king = new JLabel(new ImageIcon(new ImageIcon("images/용훈.jpg").getImage().getScaledInstance(180, 250, 0)));
		...
		clientNick.setFont(new Font("고딕", Font.BOLD, 20));
		...
		clientWin.setFont(new Font("고딕", Font.BOLD, 20));
		...
		clientDream.setFont(new Font("고딕", Font.BOLD, 20));
