...
public class YH_QuizAnswer_ej1 extends JTextField {
	...
	public YH_QuizAnswer_ej1() {

	}

	public YH_QuizAnswer_ej1(JPanel panel, YH_Quiz[][][] quiz, String[] compareArr, JLabel[][] l, int i1, int j1,
			/* InGamePage igp */InGamePage igp, YH_GameBoard_ej1[] gb, int f) {
		this.panel = panel;
		this.quiz = quiz;
